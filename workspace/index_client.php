...
<head>
    <meta charset="utf-8">
    <title><?php echo $client['prenom_client'] . " " . $client['nom_client']; ?></title>
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-2 mt-2">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"><?php echo $client['prenom_client'] . " " . $client['nom_client']; ?></h6>
                        <small>Client</small>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link" onclick="lister_mes_offres();">
                        <small>
                            <i class="bi bi-list bg-light"></i>
                            Mes Offres
                        </small>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div style="box-shadow: 4px 6px 6px #666;" class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="core/client/deconnecter.php" class="dropdown-item">
                                <small>Log out</small>
                            </a>
                        </div>
                    </div>
    ...
    <script src="js/global_client.js"></script>
</body>
