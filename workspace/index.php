...
$admin = isset($_SESSION['admin']) ? $_SESSION['admin'] : header('location: core/admin/deconnecter.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="utf-8">
    <title><?php echo $admin['nom_administrateur'].' '.$admin['prenom_administrateur'].' spacework'; ?></title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-2 mt-2">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"><?php echo $admin['nom_administrateur'].' '.$admin['prenom_administrateur']; ?></h6>
                        <small>Administrateur</small>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                <a href="#" class="nav-item nav-link" onclick="lister_domaines();">
                        <small>
                    ...
                    <a href="#" class="nav-item nav-link" onclick="lister_clients();">
                        <small>
                            <i class="bi bi-person-fill bg-light"></i>
                            Clients
                        </small>
                    </a>
                    <a href="#" class="nav-item nav-link" onclick="lister_prestataires();">
                        <small>
                            <i class="bi bi-person-fill bg-light"></i>
                            Prestataires
                        </small>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div style="box-shadow: 4px 6px 6px #666;" class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="core/admin/deconnecter.php" class="dropdown-item">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div id="display" class="bg-light rounded p-4" style="min-height: 400px; box-shadow: 4px 4px 8px #666;">
                ...
                <div class="rounded-top p-1">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            <small>&copy; <a href="#">TAKI KHOUALDI</a>, All Right Reserved.</small>
                        </div>
